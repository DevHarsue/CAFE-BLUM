...
"")
        ...
        self.lineEdit_4 = QLineEdit(self.contenedor_principal)
    ...
    def retranslateUi(self, Configuracion):
        Configuracion.setWindowTitle(QCoreApplication.translate("Configuracion", u"CONFIGURAR CONEXION CON LA BD", None))
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("Configuracion", u"USUARIO", None))
        self.label.setText(QCoreApplication.translate("Configuracion", u"INICIO DE SESI\u00d3N", None))
        self.lineEdit_2.setPlaceholderText(QCoreApplication.translate("Configuracion", u"CONTRASE\u00d1A", None))
